...
import { Plus, Edit2, Trash2, Gamepad2, Eye } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Gestión de Juegos</h2>
          <p className="text-sm text-gray-600 mt-1">Administra los juegos del sistema</p>
        </div>
        <button
          ...
          {games.map((game) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600 mb-4">
                ...
                <div className="flex items-center justify-between">
                  <span>Números:</span>
                  <span className="font-medium">{game.totalNumbers}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Slug:</span>
