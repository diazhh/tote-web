/**
 * Mapa de slots fijos para el proveedor WinBigVzla.
 *
 ...
 *
 * Modelo de slots explícitos: cada juego tiene su propio rango de IDs. No se
 * usa desambiguación por longitud de número — el drawSlotId resuelve el juego.
 *
 * Estructura:
