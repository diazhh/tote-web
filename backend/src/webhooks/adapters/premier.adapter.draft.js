/**
 * Adapter para proveedor: Premier
 *
 * Transforma el payload del proveedor Premier al contrato normalizado
...
import SLOTS from './premier.slots.js';
...
/**
 * Normaliza el payload del proveedor Premier.
 *
