...
router.get('/game/:gameId/stats', authenticate, authorize('ADMIN', 'OPERATOR'), tripletaController.getGameTripletaStats);

router.post('/check-draw/:drawId', authenticate, authorize('ADMIN', 'OPERATOR'), tripletaController.checkTripleBetsForDraw);
